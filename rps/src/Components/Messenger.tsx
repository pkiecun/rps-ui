...
const Messenger: React.FC = () => {
    ...
    const [gameData, setGameData] = useState<IGame>({matchTo: 0, wins: 0, losses: 0, gameOver: false});
    ...
    useEffect(()=>{
        ...
        if(bigGame.matchTo === 0 && userData.message.limit){dispatch(updateGame(userData.message.limit));}
        if(usersChoice !== 0 && opponentsChoice !== 0 && game.userChoice === 0 && game.opponentChoice === 0 && !stopper){
        ...
        console.log("useeffect connected?: " + userData.connected + " username = " + userName);
        ...
        switch (payloadData.status) {
            case "JOIN":
                console.log(publicChats);
                 if (!publicChats.get(payloadData.senderName) && !privateChats.get(payloadData.senderName)) {
    ...
    return (
        ...
        <div className="send-message">
            ...
            {game.userChoice !== 0 && game.opponentChoice !== 0 && game.winner !==4 && !bigGame.gameOver ?
                <>
                <Result {...game}/>
                <button id = "2" onClick={handleClick}>Choose Next Move</button>
                </>
                : <></>
            }
            <>
