      ...
      <div className="overall">
        ...
        <div className="super-container">
          <BouncyDiv className="res-container">
            {round.userChoice === 1 ? (
              <img className="res-img" src={RockP1} alt="picOfRock" />
            ) : (
              <></>
            )}
            {round.userChoice === 2 ? (
              <img className="res-img" src={PaperP1} alt="picOfPaper" />
            ) : (
              <></>
            )}
            {round.userChoice === 3 ? (
              <img className="res-img" src={ScissorsP1} alt="picOfScissors" />
            ) : (
              <></>
            )}
          </BouncyDiv>
          <BouncyDiv2 className="res-container">
            {round.opponentChoice === 1 ? (
              <img className="res-img2" src={RockP2} alt="picOfRock" />
            ) : (
              <></>
            )}
            {round.opponentChoice === 2 ? (
              <img className="res-img2" src={PaperP2} alt="picOfPaper" />
            ) : (
              <></>
            )}
            {round.opponentChoice === 3 ? (
              <img className="res-img2" src={ScissorsP2} alt="picOfScissors" />
            ) : (
              <></>
            )}
          </BouncyDiv2>
        </div>
        <button title="home" id="0" className="home-btn" onClick={handleClick}>
          Home
        </button>
      </div>
    </>
